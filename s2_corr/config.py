...
def add_s2_corr_config(cfg):
    ...
    cfg.MODEL.SEM_SEG_HEAD.CHUNK_SIZES = 12
    ...
    cfg.MODEL.SEM_SEG_HEAD.ENABLE_HIGH_RES = False
    cfg.MODEL.SEM_SEG_HEAD.GAMMA = [0.6, 0.7]


    cfg.TEST.SLIDING_WINDOW = False
    cfg.TEST.SW_KERNEL = 384
    cfg.TEST.SW_OVERLAP = 0.333
    cfg.TEST.SW_OUT_RES = (640, 640)