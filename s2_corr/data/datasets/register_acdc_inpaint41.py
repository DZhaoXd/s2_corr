...
def register_all_custom_street(root="/data/yrz/repos/sd_inpaint/Open_Class_ACDC_v2_labeling_format"):
    img_dir = os.path.join(root, "images")
    label_dir = os.path.join(root, "labels")
    register_custom_street("acdc_inpaint41_test", img_dir, label_dir, class_names=None)
